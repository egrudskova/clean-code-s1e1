...
var taskInput=document.querySelector('.section__input_new');//Add a new task.
var addButton=document.querySelector('.section__button_add');//first button
var incompleteTaskHolder=document.querySelector('.section__list_todo');//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="section__input section__input_text task";
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector('.section__label').classList.toggle('section__label_completed')
